		...
		<div class="row my-5">
			...
			<div class="col-sm-offset-2 col-sm-8">
				...
				<div class="bg-white rounded shadow-sm container p-3">
													  <!-- onsubmit : 제출이 됐을 때 -->
					<form method="POST" action="secession" name="secession" onsubmit="return secessionValidate();" 
