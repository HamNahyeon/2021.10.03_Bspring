...
<%-- fn태그 : JSTL에서 문자열과 관련된 메서드를 제공하는 태그
...
<body>
	...
	<script>
		...
		// 변수명 중복 해결 + 속도 적 측면에서 우위를 가짐
			
		// 전화번호 첫 번째 자리 지정하기
		(function(){
			/* 이름이 phone1인 태그의 option -> 전화번호 앞자리가 적힌 option 요소를 배열로 얻어옴 */
			// each(function(index, item){} : 배열을 반복 접근하는 jQuery메서드
			// index : 현재 접근한 인덱스 번호
			// item : 현재 접근한 요소
		...
		function memberUpdateValidate(){
			...
			// 왜? -> 커맨드 객체를 이용하여 파라미터를 한 번에 받기 쉽게 하기 위하여
